...
link-citations: yes
linkcolor: blue
abstract: 'This report presents the findings of our class project for MSiA 420 aimed at predicting the cancellation status of hotel bookings using machine learning classification models. The study employed nine different models, including Naive Bayes, Logistic Regression, KNN, Neural Network, Decision Tree, GAM, SVM, XGBoost, and Random Forest. The performance of the models was evaluated based on their misclassification rate, F-1 score, ROC AUC, and training speed. The results indicate that the best model for predicting the cancellation status of hotel bookings was Random Forest, with a misclassification rate of 11.7\% in 19.5 seconds of training, followed by Neural Network and XGBoost. Although Naive Bayes was the fastest model, it had one of the worst accuracies among the nine models. On the other hand, Random Forest was both accurate and relatively fast, while XGBoost was even faster and still relatively accurate. These findings have important implications for hotel managers and policymakers seeking to develop effective strategies for managing cancellations and optimizing their revenue streams.' 
---
